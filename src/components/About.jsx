...
const About = () => {
  ...
  useEffect(() => {
    ...
    gsap.from(".rocket-heading-desktop", {
      duration: 1,
      scrollTrigger: {
        trigger: ".rocket-heading-mobile",
        start: "top center",
    ...
    <section className="about">
      <div className="row row1">
        <div className="col col1">
          ...
          <h2 className="rocket-heading rocket-heading-desktop">about
           <span>
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 512.001 512.001" style={{ enableBackground: "new 0 0 512.001 512.001"}} xmlSpace="preserve">
                <g>
      ...
      <div className="row row2">
        <div className="col col1">
          <p>Hello there! My name is John. I'm a front-end developer from San Pedro, producing mobile-responsive, interactive and great looking websites.</p>
